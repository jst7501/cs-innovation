      ...
      <main className="max-w-4xl mx-auto my-20 px-6 md:px-8 lg:px-0 font-sans text-gray-800">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            금속 표면의 산화 스케일, 열변색, 부식층 등을 화학적으로 제거하여
            후속 공정 품질과 내구성을 향상시키는 핵심 세정 기술입니다.
          </p>
        </motion.header>
        ...
        <Section title="개요" icon={<Layers size={24} />}>
          <p>
            ...
            제거해 깨끗하고 매끄러운 상태로 만드는 핵심 공정입니다. 이 과정을
            통해 보이지 않은 미세 결함까지 정리되어 부품의 전체적인 품질이 크게
            향상됩니다.
          </p>
          <p>
            결과적으로 후속 도금, 코팅, 용접 등 다양한 공정에서
            부착력(adhesion)이 높아지고, 제품의 내구성과 성능이 안정적으로
            유지됩니다.
          </p>
        </Section>
        ...
        <Section title="장점 및 효과" icon={<CheckCircleIcon size={24} />}>
          <ul className="space-y-4">
            <li className="flex items-start">
              ...
              <div>
                <strong>내구성 향상:</strong> 부식 억제 및 표면 피로율 감소로
                제품 수명 연장
              </div>
            </li>
            <li className="flex items-start">
